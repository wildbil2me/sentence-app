# Grammar Lab — documentation

Two audiences, two folders. If you are deciding *what* Grammar Lab should do,
...
|---|---|
| [product/overview.md](product/overview.md) | What Grammar Lab is, who it's for, the problem it solves, the principles behind it, and what it deliberately does **not** do. |
...
| Document | What's in it |
|---|---|
| [project/architecture.md](project/architecture.md) | How the app is put together, the `GL` namespace, the annotation model, and why there's no build step. |
